...
#LINK: https://github.com/cmerkes/qPCR_LOD_Calc 
...
## Define your CV threshold for LoQ: There is currently no standardized maximum CV for qPCR LOQs, but studies have utilized LOQ threshold CV values ranging from 25% to 35% (Forootan et al., 2017; Kralik & Ricchi, 2017).
LOQ.Threshold <- 0.35
