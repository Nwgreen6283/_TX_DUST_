...
vc<- read_csv(here("data", "processed_data", "vc_clean_copies_daily.csv")) #Daily
vc_m<- read_csv(here("data", "processed_data", "vc_clean_copies_mon.csv"))#Monthly
vc_bo<- read_csv(here("data", "processed_data","vc_clean_copies_dail_1_50.csv")) #Ran 1:50. with 5 reps (run with 2 reps + run with 3 reps)
