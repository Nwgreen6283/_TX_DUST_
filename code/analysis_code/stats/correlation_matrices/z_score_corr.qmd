...
```{r, include = FALSE}
bo<- read_csv(here("data", "processed_data", "z_score", "bo_z_score.csv"))
c2<- read_csv(here("data", "processed_data", "z_score", "c2_z_score.csv"))
rd<- read_csv(here("data", "processed_data", "z_score", "rd_z_score.csv"))
```
