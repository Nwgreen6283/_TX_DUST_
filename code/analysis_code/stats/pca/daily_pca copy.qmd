...
vibrio<-
  master %>%
  select(site, date,copies_mL, cfu_tot, Vc, Vv, temp, sal, tss, toc, doc, don, nn, amm, dust_lag, chl)


bacteria<- 
  master %>%
  select(site, date, temp, sal, tss, toc, doc, don, nn, amm, dust_lag, tot_bacteria, do_mgl, chl)
