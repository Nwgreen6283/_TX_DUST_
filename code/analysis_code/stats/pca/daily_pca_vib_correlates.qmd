...
vibrio<-
  master %>%
  select(site, date,copies_mL, cfu_tot, Vc, Vv, Temperature, Salinity, tss, TOC, DOC, DON, NO2NO3, Ammonium, dust_lag, Chl_a)


bacteria<- 
  master %>%
  select(site, date, Temperature, Salinity, tss, TOC, DOC, DON, NO2NO3, Ammonium, dust_lag, tot_bacteria, DO_mgL, Chl_a)
