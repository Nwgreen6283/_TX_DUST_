...
#CANALS
 fig2<-
  ...
  stat_correlation(method = "pearson", label.x = 0.05,label.y = 0.75,small.r = TRUE, size = 3.5)+
  annotate("text", x = 0.035, y = 23000, label = "p = 0.005", size = 3.5)+
...
fig1<-
  ...
  stat_poly_eq(aes(x = cfu_lag, y = cfu_tot),
               rr.digits = 4, size = 3.5)+
  stat_correlation(method = "pearson",label.x = 0.05,label.y = 0.75, small.r = TRUE,size = 3.5)+
  #annotate("text", x = 0.0335, y = 900, label = "p = 0.01", size =3.5)+
...
#CANALS
 fig2<-
  ...
  stat_correlation(method = "pearson", label.x = 0.05,label.y = 0.75,small.r = TRUE, size = 3.5)+
 # annotate("text", x = 0.035, y = 2000, label = "p = 0.005", size = 3.5)+
...
fig3<-
  ...
  stat_poly_eq(aes(x = cfu_lag, y = cfu_tot),rr.digits = 4, size = 3.5)+
  stat_correlation(method = "pearson",label.x = 0.05,label.y = 0.75, small.r = TRUE, size = 3.5)+
  #annotate("text", x = 0.0335, y = 1000, label = "p = 0.02", size = 3.5)+
  labs(title = "Gulf (1-day lag to dust)",
       x = "log10(dust)",
       y = "CFU/mL")+
   theme_bw() +
