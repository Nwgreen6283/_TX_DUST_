...
fig1<-
  ...
  annotate("text", x = -1.175, y = 48000, label = "p = 0.01", size =3.5)+
...
#CANALS
 fig2<-
  ...
  stat_correlation(method = "pearson", label.x = 0.05,label.y = 0.75,small.r = TRUE, size = 3.5)+
  annotate("text", x = -1.17, y = 18000, label = "p = 0.005", size = 3.5)+
  labs(title = "Canals",
       x = "log10(dust)",
       y = "Copies/mL") +
   theme_bw()+
...
fig3<-
  ...
  stat_poly_eq(aes(x = lag, y = copies_mL),rr.digits = 4, size = 3.5)+
  stat_correlation(method = "pearson",label.x = 0.05,label.y = 0.75, small.r = TRUE, size = 3.5)+
  annotate("text", x = -1.175, y = 75000, label = "p = 0.02", size = 3.5)+
  labs(title = "Gulf",
       x = "log10(dust)",
       y = "Copies/mL")+
   theme_bw() +
