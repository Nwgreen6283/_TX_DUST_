...
## Site-specific data frames for daily
...
#BLIND OSO
write.csv(bo,file= here("data","processed_data","bo_master.csv"))

#CANALS
write.csv(c2,file= here("data","processed_data","c2_master.csv"))

#GULF
write.csv(rd,file= here("data","processed_data","rd_master.csv"))
