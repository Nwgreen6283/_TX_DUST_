...
#### Get rid of colony data

<!--# This makes everything in triplicate which messes up stats. So we will get rid of it for now -->

```{r}
cfu<- 
  cfu %>%
  select(c(site, date, cfu_avg))
cfu<- unique(cfu)
```

#### Combine data sets: (1) Dust, (2) Total Vib, (3) Environmental, (4) CFU
