...
```{r}
d<- read_csv(here("data", "raw_data", "vc_daily.csv"))
m<- read_csv(here("data", "raw_data", "vc_mon.csv"))
bo<- read_csv(here("data", "raw_data","vc_bo_daily_inh_and_reg_1_50.csv")) #Ran BO 1:50
b100<- read_csv(here("data", "raw_data","vc_bo_daily_inh_and_reg_1_100.csv")) #Ran 1:100
```
...
filter_b100<- dilution_b100 %>%
  mutate(
    day = substr(dilution_b100$Sample, 4,7),
    filter_amt = case_when(
                          Sample == "BO_7"~"100",
                          Sample == "BO_8"~"100",
                          Sample == "BO_9"~"100",
...
write.csv(final_bo, file= here("data","processed_data","vc_clean_copies_dail_1_50.csv"))

write.csv(final_b100, file= here("data","processed_data","vc_clean_copies_daily_1_100.csv"))
```
