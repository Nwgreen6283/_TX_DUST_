...
write_csv(bo_delta, here('data', 'processed_data', 'z_score', 'bo_z_score_delta.csv'))
write_csv(c2_delta, here('data', 'processed_data', 'z_score', 'c2_z_score_delta.csv'))
write_csv(rd_delta, here('data', 'processed_data', 'z_score', 'rd_z_score_delta.csv'))
```
